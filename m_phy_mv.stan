...
if ( food_store_missing[i]==1 && labor_share_missing[i]==0 ) {
 ...
 lp[1] = log(pr_store) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]] +  b[2]*hunt_s[i] + b[3]*1 + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*labor_share[i] + b[11]*comm_size_merged[i]);
 
  // Model where storage is absent, weightted by the probability of no food storage
 lp[2] = log(1-pr_store) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]] + b[2]*hunt_s[i] + b[3]*0 + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*labor_share[i] + b[11]*comm_size_merged[i]);
...
// Labor missing, food storage observed
 ...
 lp[1] = log(pr_labor) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]] +  b[2]*hunt_s[i] + b[3]*food_store[i] + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*1 + b[11]*comm_size_merged[i]);
 
  // Model where labor is absent
 lp[2] = log(1-pr_labor) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]] + b[2]*hunt_s[i] + b[3]*food_store[i] + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*0 + b[11]*comm_size_merged[i]);
...
// Both missing
      ...
      vector[4] lp; // log-lik containers to marginalize over
        ...
        // Pr (Labor Absent, Storage Absent) = (1 - Pr(Labor Present)) * (1 - Pr(Storage Present))
          ...
          lp[1] = log( inv_logit(a[10] + res_v[i,10]) * inv_logit(a[3] + res_v[i,3]) ) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]]  + b[2]*hunt_s[i] + b[3]*1 + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*1 + b[11]*comm_size_merged[i]);
          
          lp[2] = log( inv_logit(a[10] + res_v[i,10]) * (1-inv_logit(a[3] + res_v[i,3])) ) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]]  + b[2]*hunt_s[i] + b[3]*0 + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*1 + b[11]*comm_size_merged[i]);
          
          lp[3] = log( (1-inv_logit(a[10] + res_v[i,10])) * inv_logit(a[3] + res_v[i,3]) ) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]]  + b[2]*hunt_s[i] + b[3]*1 + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*0 + b[11]*comm_size_merged[i]);
          
          lp[4] = log( (1-inv_logit(a[10] + res_v[i,10])) * (1-inv_logit(a[3] + res_v[i,3]))) + bernoulli_logit_lpmf(y[i] | b[1] + phy_v[society[i]]  + b[2]*hunt_s[i] + b[3]*0 + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*0 + b[11]*comm_size_merged[i]);
...
p[i] = b[1] + phy_v[society[i]]  + b[2]*hunt_s[i] + b[3]*food_store[i] + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*labor_share[i] + b[11]*comm_size_merged[i];
...
trade_food[i] ~ bernoulli_logit(a[4] + res_v[i,4]);
strat[i] ~ bernoulli_logit(a[5] + res_v[i,5]);
 ...
 target += log_sum_exp(lp_labor);
  ...
  labor_share[i] ~ bernoulli_logit(a[10] + res_v[i,10]);
          ...
          store_gen[i] = bernoulli_rng( inv_logit(a[3] + res_v[i,3]) );
            ...
            p[i] = b[1] + phy_v[society[i]]  + b[2]*hunt_s[i] + b[3]*store_gen[i] + b[4]*trade_food[i] + b[5]*strat[i] + b[6]*hus_s[i] + b[7]*precip_pred_merged[i] + b[8]*temp_pred_merged[i] + b[9]*npp_pred_merged[i] + b[10]*labor_gen[i] + b[11]*comm_size_merged[i];
